...
namespace LMSProject.UI.MVC.Controllers
{
    public class LessonViewsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "LessonViewed,UserId,LessonId,DateViewed")] LessonView lessonView)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "LessonViewed,UserId,LessonId,DateViewed")] LessonView lessonView)
        {
            if (ModelState.IsValid)
            {
